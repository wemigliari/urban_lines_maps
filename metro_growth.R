...
write_xlsx(x = metro_coord, path = "/Users/wemigliari/Documents/R/tabelas/metro_coord.xlsx", col_names = TRUE)
metro_coord <- read_excel("/Users/wemigliari/Documents/R/tabelas/metro_coord.xlsx")
